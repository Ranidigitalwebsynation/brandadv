<section class="overflow-hidden space-top space-bottom" data-bg-src="assets/img/bg/sr-bg-5-1.jpg">
   <div class=" text-center wow fadeInUp" data-wow-delay="0.3s">
      <div class="title-area">
         ...
         <h2 class="sec-title">Gallery of Memorable Moments</h2>
      </div>
   </div>
   <div class="container-fluid px-0">
      <div class="row gx-2 gy-gx mb-2">
         ...
         <div class="col-sm-6 col-xl-4 col-xxl-3 wow fadeInUp" data-wow-delay="0.5s">
            <div class="gallery-style4">
               <div class="gallery-img">
         ...
         <div class="col-sm-6 col-xl-4 col-xxl-3 wow fadeInUp" data-wow-delay="0.7s">
            <div class="gallery-style4">
               <div class="gallery-img">
         ...
         <div class="text-center mt-20">
            <a href="<?php echo base_url(); ?>gallery" class="vs-btn mt-4">View All Gallery</a>
         </div>
