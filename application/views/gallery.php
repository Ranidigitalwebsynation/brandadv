...
<section class="overflow-hidden space-top space-bottom">
   ...
   <div class="container-fluid px-0">
      <div class="row gx-2 gy-gx mb-2">
         ...
         <div class="col-sm-6 col-xl-4 col-xxl-3 wow fadeInUp" data-wow-delay="0.9s">
            <div class="gallery-style4">
               <div class="gallery-img">
                  <a href="<?php echo base_url(); ?>assets/img/gallery/g-5-9.jpg">
         ...
         <div class="col-sm-6 col-xl-4 col-xxl-3 wow fadeInUp" data-wow-delay="0.9s">
            <div class="gallery-style4">
               <div class="gallery-img">
                  <a href="<?php echo base_url(); ?>assets/img/gallery/g-5-11.jpg">
